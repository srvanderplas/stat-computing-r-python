...
Both R and Python can interface with this system password storage directly, ensuring that your passwords are not stored in plaintext anywhere, including on your machine.
...
Still need to add in citations from  Zotero... 
