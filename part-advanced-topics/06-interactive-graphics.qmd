...
Posit has a set of well produced video tutorials to introduce Shiny. I'd recommend you at least listen to the [introduction](https://shiny.posit.com/tutorial/) if you're a visual/audio learner (the whole tutorial is about 2 hours long). 
There is also a [written tutorial](https://shiny.posit.com/tutorial/written-tutorial/lesson1/) if you prefer to learn in written form (7 lessons, each is about 20 minutes long).
...
- [Shiny articles](https://shiny.posit.com/articles/)
