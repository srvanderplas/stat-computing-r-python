...
In this chapter, I will focus primarily on `tabula`, since it works across both R and Python, but if you ever run into issues using it, consider `camelot` as well -- it has some cool features. 
