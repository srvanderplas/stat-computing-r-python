...
There are *many* other options out there - `d3.js`, `Observable.js`, `highCharts`, `crosstalk` (an interface specifically designed for Shiny and markdown) [@mockClientsideInteractivityMore2020].
