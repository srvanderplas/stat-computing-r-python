...
![R environment mangement <br/>[Image source](https://southblueprint.com/28045/opinions/my-backpack-looks-like-a-mess-and-i-am-okay-with-it/)](../images/gen-prog/messy-backpack.jpg){#fig-env-mgmt-R fig-alt="A backpack full of looseleaf papers in a jumble"}

![Python environment management <br/>[Image source](https://images.rawpixel.com/image_800/cHJpdmF0ZS9zdGF0aWMvaW1hZ2Uvd2Vic2l0ZS8yMDIyLTA0L2xyL3B4NTM2Njc2LWltYWdlLWt3dnZlcm44LmpwZw.jpg)](../images/gen-prog/notebooks.jpg){#fig-env-mgmt-py fig-alt="A stack of spiral notebooks"}
...
### Python-like R environments (Advanced)
...
pkgs["functions"] = pkgs['abbrev'].apply(lambda x: dir(x), by_row="compat") # <2>
