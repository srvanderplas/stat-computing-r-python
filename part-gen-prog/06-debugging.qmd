...
```{r}
#| label: map-hurricane-tracks-setup
#| error: !expr T
# Make base map to be used for each iteration
basemap <-  ggplot() + 
  # Country shapes
...
```{r}
#| label: map-hurricane-tracks-loop
for (i in 1:5) {
...
```{r}
#| label: hurricane-tracks-debugging-head
head(storms)
```
...
```{r}
#| label: hurricane-tracks-debugging-loop2
#| error: !expr T
for (i in 1:5) {
  print(paste0("Category ", i, " storms"))
  # Subset the data
...
```{r}
#| label: hurricane-tracks-debugging-3
...
```{r}
#| label: hurricane-tracks-debugging-4
#| error: !expr T
for (i in 1:5) {
  print(paste0("Category ", i, " storms"))
  # Subset the data
...
```{r}
#| label: hurricane-tracks-debugging-5
#| error: !expr T
for (i in 1:5) {
  # print(paste0("Category ", i, " storms"))
...
```{python}
#| label: tryitout-xkcd-solution-py
#| error: !expr T
from bs4 import BeautifulSoup
import urllib.request # work with html
from PIL import Image # work with images
...
```{r}
#| label: debug-demo-tryitout-solution
