...
Download [scripts.zip](../files/scripts.zip) and unzip the file.

Open a system terminal in the directory where you unzipped the files OS Specific Instructions:
...
-   [Why I Don't Like Notebooks"](https://docs.google.com/presentation/d/1n2RlMdmv1p25Xy5thJUhkKGvjtV-dkAIsUXP-AL4ffI/preview#slide=id.g362da58057_0\_1) by Joel Grus at JupyterCon 2018
