...
+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
|     ![Caption](elephant.png)                                     | ![Caption](../images/tools/elephant.png){fig-alt="A line drawing of an elephant."}                                     |
+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
|     [![Caption](elephant.png)](https://quarto.org)               | [![Caption](../images/tools/elephant.png)](https://quarto.org)                                                         |
+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
|     [![Caption](elephant.png)](https://quarto.org "An elephant") | [![Caption](../images/tools/elephant.png "An elephant"){fig-alt="A line drawing of an elephant."}](https://quarto.org) |
+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
|     [![](elephant.png){fig-alt="Alt text"}](https://quarto.org)  | [![](../images/tools/elephant.png){fig-alt="A line drawing of an elephant."}](https://quarto.org)                      |
+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+
:::
...
I tend to separate things out into separate repositories, but you can host HTML content on other repositories too, by enabling github pages in the repository settings. On my personal page, I have repositories for my [CV](https://srvanderplas.github.io/CV/), Presentations, etc. Each repository that has pages enabled can be accessed via `https://srvanderplas.github.io/\<repository name\>/\<repository file path\>`. So, to see my `unl-stat850` repository, you'd go to https://srvanderplas.github.io/unl-stat850/.
