...
::: column-margin There is a [LaTeX class maintained by the UNL math department for thesis formatting](https://www.math.unl.edu/graduate/nuthesis/nuthesis.zip).
...
On my personal page, I have repositories for my [CV](https://srvanderplas.github.io/CV/), Presentations, etc.
...
So, to see my `unl-stat850` repository, you'd go to https://srvanderplas.github.io/unl-stat850/.
