...
@sec-lists discusses how to work with data stored in nested lists efficiently, though additional information is available in @sec-record-data, where these strategies are applied to record-based data. 
