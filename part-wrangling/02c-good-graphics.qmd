...
As awesome as it is to be able to use preattentive features to process information, we should not use combinations of preattentive features to show different variables. 
