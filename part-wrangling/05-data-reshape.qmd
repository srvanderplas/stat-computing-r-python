...
@internationalbusinessmachinesRisksUsingSpreadsheets2010 - IBM SPSS ad that talks about the perils of spreadsheets
...
```{r}
#| label: tidyr-pivot-longer-demo2
tba <- table4a %>% 
...
```{r}
#| label: tryitout-who-surveillance
library(readxl)
...
```{r}
#| label: tryitout-surveillance-cleaning
library(ggplot2)
library(readr)
library(tidyr)
library(stringr)
...
```{python}
#| label: tryitout-surveillance-cleaning-py
#| eval: false
import pandas as pd
...
```{r}
#| label: gas-prices-solution-step2-r
...
```{r}
#| label: gas-prices-solution-step3-r
...
```{r}
#| label: gas-prices-solution-step4-r
...
```{r}
#| label: gas-prices-solution-step5-r
...
```{r}
#| label: gas-prices-solution-step6-r
library(lubridate)
...
```{python}
#| label: gas-prices-solution-step6-py
